import type { BreakdownDimension, BreakdownRow, StatsFilter } from "@/lib/api/types"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Token usage by {dimension} in the selected range</CardDescription>
      </CardHeader>
      <CardContent>
